// components/ImageShowcasesSection.js
import React from "react";

const ImageShowcasesSection = () => {
  return (
    <section className="showcase">
      <div className="container-fluid p-0">
        <div className="row g-0">
          <div className="col-lg-6 order-lg-2 text-white showcase-img img1" />
        ...
        <div className="row g-0">
          <div className="col-lg-6 text-white showcase-img img2" />
        ...
        <div className="row g-0">
          <div className="col-lg-6 order-lg-2 text-white showcase-img img3" />
          <div className="col-lg-6 order-lg-1 my-auto showcase-text">
